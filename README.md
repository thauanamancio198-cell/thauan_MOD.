...
local FolderName = "Thauan Hub | Farm"
...
local Window = bearlib:MakeWindow({
    Title = "Thauan Hub | Farm",
    SubTitle = "by Thauan",
    SaveFolder = true,
    Image = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663496314136/XzVPmJkkDSfrlZNa.jpeg"
})
...
v0:AddProfile({
    ...
    Avatar = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663496314136/XzVPmJkkDSfrlZNa.jpeg", 
...
-- =========================================================
-- AUTO FISHING SYSTEM (Ported from Thauan Hub)
-- =========================================================
        ...
        pcall(function()
            while wait(Sec) do
                if _G.Auto_Rainbow_Haki then
                    -- Copy logic Rainbow Haki từ file Thauan Hub.txt (dòng 2058-2154) vào đây nếu cần
